...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: 'img/avatars/8.jpg', status: 'success' },
          user: { name: 'Farhood Rashidi', new: true, registered: 'Jan 1, 2019' },
          country: { name: 'USA', flag: 'us' },
          usage: { value: 50, period: 'Jun 11, 2015 - June 10, 2019' },
          payment: { name: 'Mastercard', icon: 'fa fa-cc-mastercard' },
          activity: '10 sec ago'
        },
        {
          avatar: { url: 'img/avatars/2.jpg', status: 'danger' },
          user: { name: 'Meli', new: false, registered: 'Jan 1, 2019' },
          country: { name: 'USA', flag: 'us' },
        ...
        {
          avatar: { url: 'img/avatars/7.jpg', status: 'warning' },
          user: { name: 'Chad', new: true, registered: 'Jan 1, 2019' },
          country: { name: 'USA', flag: 'us' },
