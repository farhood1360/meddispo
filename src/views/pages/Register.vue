        ...
        <b-col md="6" sm="8">
          <b-card no-body class="mx-4">
            ...
            <b-card-footer class="p-4">
              <b-row><p>Are you a business owner in Katy Area?</p></b-row>
              <b-row>
                <b-col cols="6">
                  <b-button block class="btn btn-facebook"><span>YES</span></b-button>
                </b-col>
                <b-col cols="6">
                  <b-button block class="btn btn-twitter" type="button"><span>NO</span></b-button>
                </b-col>
              </b-row>
            </b-card-footer>
          </b-card>
